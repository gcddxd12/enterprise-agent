...
class QueryExpander:
    ...
    def __init__(self, llm=None, use_mock: bool = True):
        ...
        self.synonyms = {
            # 套餐与资费
            "套餐": ["资费", "月租", "5G套餐", "4G套餐", "流量套餐", "语音套餐", "融合套餐"],
            "流量": ["上网流量", "数据流量", "4G流量", "5G流量", "通用流量", "定向流量", "闲时流量"],
            "话费": ["账单", "月租费", "通信费", "消费", "扣费", "余额", "费用"],
            "宽带": ["光纤", "光宽带", "FTTR", "全屋光宽带", "家庭宽带", "宽带提速"],
            # 网络与技术
            "5G": ["5G网络", "5G-A", "第五代移动通信", "5G专网", "5G覆盖", "5G信号"],
            "信号": ["覆盖", "网速", "速率", "带宽", "延迟", "时延", "网络质量", "弱覆盖"],
            "基站": ["宏站", "微站", "室分", "铁塔", "站点", "发射塔"],
            # 业务与产品
            "物联网": ["IoT", "NB-IoT", "Cat.1", "物联卡", "OneNET", "智能终端"],
            "云服务": ["移动云", "云桌面", "云存储", "云计算", "云主机", "云服务器"],
            "专线": ["政企专线", "互联网专线", "数据专线", "组网专线", "SD-WAN"],
            "算力": ["算力网络", "算网", "边缘算力", "GPU算力", "东数西算", "算力调度"],
            # 业务办理
            "办卡": ["开户", "入网", "办号码", "选号", "开卡", "新入网"],
            "销户": ["注销", "销号", "退网", "取消", "停机"],
            "携号转网": ["携转", "转网", "携号转入", "携号转出", "换运营商"],
            "充值": ["缴费", "交费", "充值话费", "充流量", "购买流量包"],
            # 服务与权益
            "积分": ["积分兑换", "积分商城", "M值", "会员积分", "积分清零"],
            "会员": ["星级", "星级用户", "会员权益", "VIP", "星级特权"],
            "客服": ["10086", "人工客服", "在线客服", "客服热线", "咨询", "投诉"],
            "营业厅": ["服务厅", "移动营业厅", "线下办理", "就近营业厅", "网点"],
            # 安全与认证
            "SIM卡": ["手机卡", "电话卡", "SIM", "eSIM", "卡号", "号码"],
            "实名制": ["实名认证", "实名登记", "身份证认证", "人脸识别", "身份验证"],
            # 增值业务
            "彩铃": ["视频彩铃", "彩铃包月", "个性彩铃"],
            "漫游": ["国际漫游", "港澳台漫游", "跨境通信", "境外流量"],
        }
